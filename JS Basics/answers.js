...
// // Q5
let x = 42; // Declare x to avoid global variable
console.log(global.x === x);
//true (when initialize x without declar using var, let, const will be global variable)
// // Q6
function test() {
    let z = 1;
    return function () {
...
// to log 0 1 2 just replace var with let=> create new variable contain value for each iteration
